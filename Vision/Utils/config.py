...
STEERING_KI = 0.007
STEERING_KD = 0.01
PID_CONSTANT_NEEDED_TO_MAX_RIGHT_STEERING_ANGLE = -1000
PID_CONSTANT_NEEDED_TO_MAX_LEFT_STEERING_ANGLE = 1000
...
Minimum_Contour_Size = {
    ...
    BLUE_TRACK_LINES_HSV: 250,
    YELLOW_TRACK_LINES_HSV: 250,
    RIVAL_BOT_HSV: 0,
    ARROW_HSV: 0
}
